...
- Create Angular project with ng: `ng new aifutuerx_task.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`aifutuerx_task.client.esproj`).
